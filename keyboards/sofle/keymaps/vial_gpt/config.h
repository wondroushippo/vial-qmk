...
#ifdef MASTER_LEFT
    // — PS/2 TrackPoint on left half —
    // pick the pins your TrackPoint CLK/DATA attach to:
    #define PS2_CLK_PIN   D3
    #define PS2_DATA_PIN  D2
#endif

#ifdef MASTER_RIGHT
    // — Azoteq IQS5xx touchpad on right half —
    // pick your I²C pins:
    #define AZOTEQ_IQS5XX_TPS43
#endif

// how often QMK polls each device (ms)
#define POINTING_DEVICE_DELAY_MS 10
